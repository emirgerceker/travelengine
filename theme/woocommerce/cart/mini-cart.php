		...
		?>
				<li class="woocommerce-mini-cart-item <?php echo esc_attr(apply_filters('woocommerce_mini_cart_item_class', 'mini_cart_item', $cart_item, $cart_item_key)); ?>">
					...
					<div class="woocommerce-mini-cart-item__summary">
						...
						<div class="woocommerce-cart-item__qty" data-nonce="<?php echo wp_create_nonce('togo-update-cart-qty--' . $cart_item_key); ?>">
							<?php
							echo apply_filters(
								...
								sprintf(
									...
									esc_attr__('Remove this item', 'togo'),
									esc_attr($product_id),
...
<?php else : ?>
	...
	<p class="woocommerce-mini-cart__empty-message"><?php esc_html_e('No products in the cart.', 'togo'); ?></p>
