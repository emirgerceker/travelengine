...
final class Kirki_Fonts
{
	...
	{
		return array(
			'100'       => esc_html__('Ultra-Light 100', 'togo'),
			'100light'  => esc_html__('Ultra-Light 100', 'togo'),
			'100italic' => esc_html__('Ultra-Light 100 Italic', 'togo'),
			'200'       => esc_html__('Light 200', 'togo'),
			'200italic' => esc_html__('Light 200 Italic', 'togo'),
			'300'       => esc_html__('Book 300', 'togo'),
			'300italic' => esc_html__('Book 300 Italic', 'togo'),
			'400'       => esc_html__('Normal 400', 'togo'),
			'regular'   => esc_html__('Normal 400', 'togo'),
			'italic'    => esc_html__('Normal 400 Italic', 'togo'),
			'500'       => esc_html__('Medium 500', 'togo'),
			'500italic' => esc_html__('Medium 500 Italic', 'togo'),
			'600'       => esc_html__('Semi-Bold 600', 'togo'),
			'600bold'   => esc_html__('Semi-Bold 600', 'togo'),
			'600italic' => esc_html__('Semi-Bold 600 Italic', 'togo'),
			'700'       => esc_html__('Bold 700', 'togo'),
			'700italic' => esc_html__('Bold 700 Italic', 'togo'),
			'800'       => esc_html__('Extra-Bold 800', 'togo'),
			'800bold'   => esc_html__('Extra-Bold 800', 'togo'),
			'800italic' => esc_html__('Extra-Bold 800 Italic', 'togo'),
			'900'       => esc_html__('Ultra-Bold 900', 'togo'),
			'900bold'   => esc_html__('Ultra-Bold 900', 'togo'),
			'900italic' => esc_html__('Ultra-Bold 900 Italic', 'togo'),
		);
	}
