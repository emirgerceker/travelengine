...
class Kirki_Field_Image extends Kirki_Field
{
	...
	protected function set_button_labels()
	{
		$this->button_labels = wp_parse_args(
			$this->button_labels,
			array(
				'select'       => esc_html__('Select image', 'togo'),
				'change'       => esc_html__('Change image', 'togo'),
				'default'      => esc_html__('Default', 'togo'),
				'remove'       => esc_html__('Remove', 'togo'),
				'placeholder'  => esc_html__('No image selected', 'togo'),
				'frame_title'  => esc_html__('Select image', 'togo'),
				'frame_button' => esc_html__('Choose image', 'togo'),
			)
		);
	}
