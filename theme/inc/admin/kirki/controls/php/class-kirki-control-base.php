	...
	public function enqueue()
	{
		...
		wp_localize_script(
			...
			array(
				...
				'noFileSelected'       => esc_html__('No File Selected', 'togo'),
				'remove'               => esc_html__('Remove', 'togo'),
				'default'              => esc_html__('Default', 'togo'),
				'selectFile'           => esc_html__('Select File', 'togo'),
				'standardFonts'        => esc_html__('Standard Fonts', 'togo'),
				'googleFonts'          => esc_html__('Google Fonts', 'togo'),
				'defaultCSSValues'     => esc_html__('CSS Defaults', 'togo'),
				'defaultBrowserFamily' => esc_html__('Default Browser Font-Family', 'togo'),
			)
		);
