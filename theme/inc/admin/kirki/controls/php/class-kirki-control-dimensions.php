...
<?php
	...
	{
		return array(
			'left-top'       => esc_html__('Left Top', 'togo'),
			'left-center'    => esc_html__('Left Center', 'togo'),
			'left-bottom'    => esc_html__('Left Bottom', 'togo'),
			'right-top'      => esc_html__('Right Top', 'togo'),
			'right-center'   => esc_html__('Right Center', 'togo'),
			'right-bottom'   => esc_html__('Right Bottom', 'togo'),
			'center-top'     => esc_html__('Center Top', 'togo'),
			'center-center'  => esc_html__('Center Center', 'togo'),
			'center-bottom'  => esc_html__('Center Bottom', 'togo'),
			'font-size'      => esc_html__('Font Size', 'togo'),
			'font-weight'    => esc_html__('Font Weight', 'togo'),
			'line-height'    => esc_html__('Line Height', 'togo'),
			'font-style'     => esc_html__('Font Style', 'togo'),
			'letter-spacing' => esc_html__('Letter Spacing', 'togo'),
			'word-spacing'   => esc_html__('Word Spacing', 'togo'),
			'top'            => esc_html__('Top', 'togo'),
			'bottom'         => esc_html__('Bottom', 'togo'),
			'left'           => esc_html__('Left', 'togo'),
			'right'          => esc_html__('Right', 'togo'),
			'center'         => esc_html__('Center', 'togo'),
			'size'           => esc_html__('Size', 'togo'),
			'spacing'        => esc_html__('Spacing', 'togo'),
			'width'          => esc_html__('Width', 'togo'),
			'height'         => esc_html__('Height', 'togo'),
			'invalid-value'  => esc_html__('Invalid Value', 'togo'),
		);
	}
}
