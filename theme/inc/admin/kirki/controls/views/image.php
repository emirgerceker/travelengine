...
<#
	...
	select: '<?php esc_html_e('Select image', 'togo'); ?>' ,
	change: '<?php esc_html_e('Change image', 'togo'); ?>' , 'default' : '<?php esc_html_e('Default', 'togo'); ?>' ,
	remove: '<?php esc_html_e('Remove', 'togo'); ?>' ,
	placeholder: '<?php esc_html_e('No image selected', 'togo'); ?>' ,
	frame_title: '<?php esc_html_e('Select image', 'togo'); ?>' ,
	frame_button: '<?php esc_html_e('Choose image', 'togo'); ?>' ,
	} );
	#>
