			...
			array(
				...
				'tabs'    => array(
					array(
						...
						'fields' => apply_filters('trip_archive_page_settings_tab', array(
							array(
								'field_type' => 'ALERT',
					...
					array(
						...
						'fields' => apply_filters('trip_archive_card_settings_tab', array(
							array(
								'field_type' => 'ALERT',
					...
					array(
						...
						'id' => 'trip-taxonomy',
						'fields' => apply_filters('trip_archive_taxonomy_settings_tab', array(
							array(
								'field_type' => 'ALERT',
