...
if ( !class_exists('Uxper_Field_Divide') ) {
	class Uxper_Field_Divide extends Uxper_Field
	{
		function render()
		{
			...
			$class_inner = array('uxper-field-divide-inner');
			if (isset($this->params['style'])) {
				$class_inner[] = 'uxper-divide-style-' . $this->params['style'];
			}
			?>
