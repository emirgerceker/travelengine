...
class Group_Control_Advanced_Border extends Group_Control_Base
{
	...
	protected function init_fields()
	{
		...
		$fields['type'] = [
			'label'     => _x('Type', 'Border Control', 'togo'),
			'type'      => Controls_Manager::SELECT,
			'options'   => [
				''       => __('Default', 'togo'),
				'none'   => __('None', 'togo'),
				'solid'  => _x('Solid', 'Border Control', 'togo'),
				'double' => _x('Double', 'Border Control', 'togo'),
				'dotted' => _x('Dotted', 'Border Control', 'togo'),
				'dashed' => _x('Dashed', 'Border Control', 'togo'),
				'groove' => _x('Groove', 'Border Control', 'togo'),
			],
			'selectors' => [
		...
		$fields['color'] = [
			'label'     => _x('Color', 'Border Control', 'togo'),
		...
		$fields['width'] = [
			'label'      => _x('Width', 'Border Control', 'togo'),
		...
		$fields['radius'] = [
			'label'      => _x('Rounded', 'Border Control', 'togo'),
			'type'       => Controls_Manager::DIMENSIONS,
			'size_units' => ['px', '%'],
			'selectors'  => [
	...
	protected function get_default_options()
	{
		return [
			'popover' => [
				'starter_title' => _x('Border', 'Advanced Border Control', 'togo'),
				'starter_name'  => 'enable',
				'starter_value' => 'yes',
				'settings'      => [
					'render_type' => 'ui',
