...
/**
 * Class Togo_Thumbnail_Widget.
 *
 * A widget for displaying thumbnails.
 *
 * @package Togo_Elementor
 */
class Widget_Thumbnail extends \Togo_Framework\Elementor\Base
{
    ...
    {
        return __('Trip Destinations - Thumbnail', 'togo-framework');
    }
