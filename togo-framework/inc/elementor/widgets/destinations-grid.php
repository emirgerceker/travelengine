...
/**
 * Class Togo_Destinations_Grid_Widget
 *
 * Elementor widget for displaying destinations.
 *
 * @since 1.0.0
 */
class Togo_Destinations_Grid_Widget extends Base
{
    ...
    {
        return __('Destinations Grid', 'togo-framework');
    }
    ...
    protected function add_content_section()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'grid-01' => __('Grid 01', 'togo-framework'),
                    'grid-02' => __('Grid 02', 'togo-framework'),
                    'grid-03' => __('Grid 03', 'togo-framework'),
                ],
                'default' => 'grid-01',
            ]
        );
    ...
    protected function render()
    {
        ...
        $row_gap = $settings['row_gap'] ? $settings['row_gap'] : 20;
        $column_gap = $settings['column_gap'] ? $settings['column_gap'] : 20;
        ...
        $this->add_render_attribute('wrapper', 'class', 'togo-destinations-grid-wrapper ' . $settings['layout']);
        $this->add_render_attribute('grid', 'class', 'togo-destinations-grid');
